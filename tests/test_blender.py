...
conftest auto-discovers qwen_mm_plugins_blender (it scans src/capabilities/*/ for the
...
import qwen_mm_plugins_blender as m

BLENDER_SERVER_DIR = os.path.join(REPO_ROOT, "src", "capabilities", "blender", "qwen_mm_plugins_blender")
...
def test_execute_code_degrades_gracefully(monkeypatch):
    ...
    import qwen_mm_plugins_blender.loader as loader
...
def test_hyper3d_url_validation_rejects_garbage():
    ...
    from qwen_mm_plugins_blender.tools.generate_hyper3d_model_via_images import _valid_url
